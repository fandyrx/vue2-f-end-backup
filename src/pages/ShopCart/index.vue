  ...
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart,index) in cartInfoList" :key="cart.id">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list"   @change="updataChecked(cart,$event)" :checked='cart.isChecked == 1'>
          </li>
    ...
    <div class="cart-tool">
      ...
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isAllChecked &&cartInfoList.length>0"  @click="updataAllCartChecked">
        <span>全选</span>
      </div>
...
import throttle from "lodash/throttle";
  export default {
    ...
    computed:{
      ...
      //判断购物车列表所有元素，isChecked属性是否都为1 (已勾选状态)
      isAllChecked(){
